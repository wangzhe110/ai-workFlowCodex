...
def test_confirmed_story_can_generate_configurable_storyboard() -> None:
    with TestClient(app) as client:
        ...
        client.post(f"/api/v1/projects/{pid}/source-video", files={"file": ("source.mp4", b"x", "video/mp4")}); client.post(f"/api/v1/projects/{pid}/analysis-runs"); client.post(f"/api/v1/projects/{pid}/topic-generation-runs")

        ...
        traces.append(
            {
                ...
                "prompt_name": prompt_snapshot.get("name") if isinstance(prompt_snapshot.get("name"), str) else (prompt.name if prompt else None),
                "prompt_version": prompt_snapshot.get("version") if isinstance(prompt_snapshot.get("version"), int) else (prompt.version if prompt else None),
